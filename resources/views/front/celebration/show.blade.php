        ...
        <section class="container">
            <div class="about_us__cart">
                ...
                <ul class="about_us__menu">
                    <li>
                        <a href="{{ route('forcelebrations') }}" class="about_us__menu__link">@lang('main.for_celebrations')</a>
                    </li>
                    ...
                    <section>
                        ...
                        <ul class="catalog_inside__menu">
                            ...
                            <li>
                                ...
                                <h4 class="catalog_inside__title__h4">{{ $forcelebration->weight }} @lang('main.gr')</h4>
                            </li>
                        ...
                        <h3 class="catalog_inside__title__h3">{{ $forcelebration->price }}<span>@lang('main.sum')</span></h3>
