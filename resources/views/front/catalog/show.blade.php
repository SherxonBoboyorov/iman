        ...
        <section class="container">
            <div class="about_us__cart">
                ...
                <ul class="about_us__menu">
                    ...
                    <li>
                        <a href="catalog_inside.html" class="about_us__menu__link">Incididunt ut labore</a>
                    </li>
                </ul>
            </div>
        </section>
                ...
                <div class="catalog_inside__list">
                    ...
                    <section>
                        ...
                        <ul class="catalog_inside__menu">
                            <li>
                                <span>Упаковка:</span>
                                <h4 class="catalog_inside__title__h4">Коробка с логотипом</h4>
                            </li>

                            <li>
                                <span>Вес:</span>
                                <h4 class="catalog_inside__title__h4">300 гр</h4>
                            </li>

                            <li>
                                <span>Состав:</span>
                                <h4 class="catalog_inside__title__h4">Lorem ipsum dolor, sit amet, consectetur adipiscing elit, sed do eiusmod, tempor</h4>
                            </li>

                            <li>
                                <span>Срок годности:</span>
                                <h4 class="catalog_inside__title__h4">12 месяцев</h4>
                            </li>
                        </ul>

                        <h3 class="catalog_inside__title__h3">110 000 <span>сум</span></h3>
