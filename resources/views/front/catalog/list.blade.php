...
<head>
    ...
    <title>Шоколадные конфеты</title>
</head>
<body>
                ...
                <div class="header__list">
                    ...
                    <menu class="sidenav" id="slide-out">
                        <ul class="header__menu">
                            ...
                            <li>
                                <a href="catalog.html" class="header__menu__link">каталог</a>
                            </li>

                            <li>
                                <a href="new.html" class="header__menu__link">новинки</a>
                            </li>
        ...
        <section class="container">
            <div class="about_us__cart">
                ...
                <ul class="about_us__menu">
                    <li>
                        <a href="catalog.html" class="about_us__menu__link">Каталог</a>
                    </li>

                    <li>
                        <a href="catalog_in.html" class="about_us__menu__link">Шоколадные конфеты</a>
                    </li>
                </ul>
            </div>
        </section>
        ...
        <section class="container">
            <div class="catalog_in__cart">
                <div class="catalog_in__list">
                    ...
                    <div class="new__item">
                        <div class="new__img">
                            <img src="foto/new_1.png" alt="new">
                        </div>

                        <div class="new__button">
                            <a href="catalog_inside.html" class="new__link">Подробнее</a>
                        </div>

                        <h3 class="new__title__h3">Lorem ipsum dolor</h3>
                        <div class="new__text">
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing</p>
                        </div>
                        <h4 class="new__sum">120 000<span>сум</span></h4>
                    </div>

                    <div class="new__item">
                        <div class="new__img">
                            <img src="foto/new_2.png" alt="new">
                        </div>
                        ...
                        <h3 class="new__title__h3">Incididunt ut labore</h3>
                        <div class="new__text">
                            <p>tempor incididunt ut labore et dolore magna aliqua</p>
                        </div>
                        <h4 class="new__sum">80 000<span>сум</span></h4>
                    </div>

                    <div class="new__item">
                        <div class="new__img">
                            <img src="foto/new_3.png" alt="new">
                        </div>
                        ...
                        <h3 class="new__title__h3">Ut enim ad minim veniam</h3>
                        <div class="new__text">
                    ...
                    <div class="new__item">
                        <div class="new__img">
                            <img src="foto/new_4.png" alt="new">
                        </div>
                    ...
                    <div class="new__item">
                        <div class="new__img">
                            <img src="foto/new_5.png" alt="new">
                        </div>
                    ...
                    <div class="new__item">
                        <div class="new__img">
                            <img src="foto/new_6.png" alt="new">
                        </div>
                    ...
                    <div class="footer__list">
                        <div class="footer__list__item">
                            <div class="footer__logo">
                                <a href="index.html">
                                    <img src="foto/logo_footer.svg" alt="logo_footer">
                                </a>
                            </div>
