        ...
        <section class="container">
            <div class="about_us__cart">
                ...
                <ul class="about_us__menu">
                    ...
                    <li>
                        <a href="to_corporative.html" class="about_us__menu__link">Корпоративным клиентам</a>
                    </li>
                </ul>
            </div>
        </section>
    ...
    <div class="to_corporative">
        <section class="container">
            <div class="to_corporative__cart">
                <h2 class="new__title__h2">ИМАН – Идеальный подарок для успешного бизнеса </h2> 
                ...
                <div class="to_corporative__text clearfix">
                    ...
                    <img src="foto/to_corporative_2.png" alt="to_corporative">
                    <img src="foto/to_corporative_3.png" alt="to_corporative">

                    <p>
                        Utenim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit, qui in ea voluptate velit esse, quam nihil molestiae consequatur, vel illum, qui dolorem eum fugiat, quo voluptas nulla pariatur? At vero eos et accusamus et iusto odio dignissimos ducimus, qui blanditiis praesentium voluptatum deleniti atque corrupti, quos dolores et quas molestias excepturi sint, obcaecati cupiditate non provident, similique sunt in culpa, qui officia deserunt mollitia animi, id est laborum et dolorum fuga. Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio, cumque nihil impedit, quo minus id, quod maxime placeat, facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet, ut et voluptates repudiandae sint et molestiae non recusandae. Itaque earum rerum hic tenetur a sapiente delectus, ut aut reiciendis voluptatibus maiores alias consequatur aut perferendis doloribus asperiores repellat.
                    </p><br><br>
