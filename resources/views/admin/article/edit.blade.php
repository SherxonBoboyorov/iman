                ...
                <div class="card-body">
                    ...
                    <div class="row" style="margin-top: 15px">
                     <div class="col-md-6">
                        ...
                        <input type="text" id="package_uz" value="{{ $article->package_uz }}" class="form-control" name="package_uz">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="package_ru" value="{{ $article->package_ru}}" class="form-control" name="package_ru">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="package_en" value="{{ $article->package_en }}" class="form-control" name="package_en">
                        ...
                        <br>
                          ...
                          <div class="row" style="margin-top: 15px">
                            <div class="col-md-3">
                                ...
                                <input type="number" id="weight" value="{{ $article->weight }}" class="form-control" name="weight">
                        ...
                        <div class="row" style="margin-top: 15px">
                            ...
                            <input type="text" id="compound_uz" value="{{ $article->compound_uz }}" class="form-control" name="compound_uz">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="compound_ru" value="{{ $article->compound_ru }}" class="form-control" name="compound_ru">
                        ...
                        <div class="row" style="margin-top: 15px">
                            <div class="col-md-6">
                                ...
                                <input type="text" id="compound_en" value="{{ $article->compound_en }}" class="form-control" name="compound_en">
                        ...
                        <div class="row" style="margin-top: 15px">
                            ...
                            <input type="text" id="best_before_date_uz" value="{{ $article->best_before_date_uz }}" class="form-control" name="best_before_date_uz">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-2">
                            ...
                            <input type="text" id="best_before_date_ru" value="{{ $article->best_before_date_ru }}" class="form-control" name="best_before_date_ru">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-2">
                            ...
                            <input type="text" id="best_before_date_en" value="{{ $article->best_before_date_en }}" class="form-control" name="best_before_date_en">
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-3">
                            ...
                            <input type="number" id="price" value="{{ $article->price }}" class="form-control" name="price">
                            @if($errors->has('price'))
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="description_uz" class="my-editor" id="description_uz" cols="30" rows="10">{{ $article->description_uz }}</textarea>
                    ...
                    <div class="row" style="margin-top: 15px">
                        <div class="col-md-12">
                            ...
                            <textarea name="description_ru" class="my-editor" id="description_ru" cols="30" rows="10">{{ $article->description_ru }}</textarea>
